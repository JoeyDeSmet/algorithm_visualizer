app.component('merge-sort', {
    ...
    <div class="mergeSort">
        ...
        <div class="options">
            <div>
                <label for="number" :style="{ 'background-color' : 'white'}">Elements in array</label>
                <select id="number" v-model="number" :disabled="sorting" @change="updateArray">
                    <option>100</option>
                    <option>1000</option>
                    <option>10000</option>
                    <option>25000</option>
